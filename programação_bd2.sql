...
Função e operadores de Strings e expressões
*/
...
-- 01.2 A função LOWER converte as letras maíusculas em letras minúsculas 
SELECT LOWER("Converte TUDO para minúscula");

-- 01.3 A função LPAD (left pad) acrecente zeros (terceiro argumento) á string "123"
SELECT LPAD('123', 4, '0');
...
-- 01.6 A função REGEXP_SEBSTR procura u m detrminado padrão (segundo argumento) numa string informada (primeiro argumento)
...
-- Consutando registros usando filtro where e expressão like
